  ...
  return (
    <div className="flex flex-col h-full max-w-3xl mx-auto">
      <header className="mb-10">
        <h1 className="text-5xl font-bold text-[#154A37] leading-tight mb-2 font-display">Settings</h1>
      ...
      <div className="space-y-8">
        <div className="bg-white rounded-[2rem] border border-[#E8E2D9] p-8 shadow-sm">
          ...
          <div className="flex items-center gap-6 mb-8">
            <div className="w-24 h-24 rounded-full bg-[#154A37] border-4 border-[#E8F2EE] flex items-center justify-center text-white font-bold text-3xl shadow-sm">
              {user?.name?.charAt(0).toUpperCase()}
            </div>
            <div>
              <button className="px-4 py-2 bg-[#F5F1EA] hover:bg-[#E8E2D9] text-[#1A1A1A] rounded-full text-sm font-semibold transition-colors">
                Change Avatar
              </button>
            </div>
          </div>
          ...
          <div className="mt-8 flex justify-end">
            <button className="px-8 py-3 bg-[#154A37] hover:bg-[#1E6B50] text-white rounded-full font-bold transition-colors">
              Save Changes
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[2rem] border border-[#E8E2D9] p-8 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <button className="px-6 py-2 bg-[#F5F1EA] hover:bg-[#E8E2D9] text-[#1A1A1A] rounded-full text-sm font-semibold transition-colors">
              Update Password
            </button>
          </div>
        </div>
