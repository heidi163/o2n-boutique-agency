  ...
  return (
    <div className="flex flex-col h-full max-w-3xl mx-auto">
      <header className="mb-10">
        <h1 className="text-xl tracking-tight tracking-tight font-normal text-[#154A37] leading-tight mb-2 ">Settings</h1>
      ...
      <div className="space-y-8">
        <div className="bg-white rounded-[2rem] border border-[#E8E2D9] p-8 shadow-sm">
          <h2 className="text-lg tracking-tight font-normal  mb-6">Profile Information</h2>
          
          <div className="flex items-center gap-6 mb-8">
            <div className="w-24 h-24 rounded-full bg-[#154A37] border-4 border-[#E8F2EE] flex items-center justify-center text-white font-normal text-xl tracking-tight shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-normal text-[#1A1A1A] mb-2">Full Name</label>
            ...
            <div>
              <label className="block text-sm font-normal text-[#1A1A1A] mb-2">Email Address</label>
            ...
            <div>
              <label className="block text-sm font-normal text-[#1A1A1A] mb-2">Job Title</label>
            ...
            <div>
              <label className="block text-sm font-normal text-[#1A1A1A] mb-2">Role</label>
          ...
          <div className="mt-8 flex justify-end">
            <button className="px-8 py-3 bg-[#154A37] hover:bg-[#1E6B50] text-white rounded-full font-normal transition-colors">
              Save Changes
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[2rem] border border-[#E8E2D9] p-8 shadow-sm">
          <h2 className="text-lg tracking-tight font-normal  mb-6">Security</h2>
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-normal text-[#1A1A1A] mb-2">Current Password</label>
            ...
            <div>
              <label className="block text-sm font-normal text-[#1A1A1A] mb-2">New Password</label>
              <input type="password" placeholder="••••••••" className="w-full bg-[#FDFBF7] border border-[#E8E2D9] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#154A37] focus:border-transparent transition-all max-w-md" />
            </div>
