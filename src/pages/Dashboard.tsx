  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <header className="flex justify-between items-start mb-10">
        <div>
          <h1 className="text-xl tracking-tight font-normal text-[#154A37] leading-tight mb-2 ">Dashboard</h1>
        ...
        <div className="flex gap-4">
          <button className="px-6 py-2 border border-[#E8E2D9] rounded-full text-sm font-normal hover:bg-white bg-transparent">Search...</button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 flex-1">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white p-6 rounded-3xl border border-[#E8E2D9] shadow-sm">
              ...
              <h3 className="text-lg tracking-tight font-normal text-[#154A37]">{totalTasks}</h3>
            </div>
            <div className="bg-[#154A37] p-6 rounded-3xl border border-[#154A37] shadow-sm">
              ...
              <h3 className="text-lg tracking-tight font-normal text-white">{completionRate}%</h3>
            </div>
            <div className="bg-white p-6 rounded-3xl border border-[#E8E2D9] shadow-sm">
              <p className="text-xs uppercase tracking-widest text-[#6B6B6B] mb-2 font-normal">Active Projects</p>
              <h3 className="text-lg tracking-tight font-normal text-[#154A37]">{activeProjects}</h3>
            </div>
          </div>

          <div className="bg-white rounded-[2.5rem] border border-[#E8E2D9] p-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-normal ">Active Projects</h2>
            ...
            <div className="space-y-4">
              ...
              {projects.slice(0, 5).map((project: any) => (
                <div key={project.id} className="flex items-center gap-6 p-4 rounded-3xl hover:bg-[#FDFBF7] transition-colors border border-transparent hover:border-[#E8E2D9]">
                  <div className="w-16 h-16 bg-[#E8F2EE] rounded-2xl flex items-center justify-center text-[#154A37] font-normal text-xl uppercase">
                    {project.name.charAt(0)}
                  </div>
                  <div className="flex-1">
                    <h4 className="font-normal text-base text-[#1A1A1A]">{project.name}</h4>
                    <p className="text-sm text-[#6B6B6B]">Client: {project.client?.name || 'Unknown'}</p>
                  </div>
                  <div className="text-right">
                    <span className="px-4 py-1 bg-[#4CAF7D]/10 text-[#4CAF7D] rounded-full text-xs font-normal inline-block mb-3">
        ...
        <div className="lg:col-span-1 flex flex-col gap-8">
          <div className="bg-[#F5F1EA] rounded-[2.5rem] p-8 flex-1">
            <h2 className="text-base font-normal mb-6 ">Live Activity</h2>
